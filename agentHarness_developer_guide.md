...
11. Debug settings also control whether per-call live terminal windows are shown on Windows and whether the left logs panel is visible. New/default projects start with the left logs panel hidden.
