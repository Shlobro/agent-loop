...
- Show generated description and loop-priority task checklist/progress in UI: `src/workers/planning_worker.py`, `src/gui/widgets/description_panel.py`, `src/gui/widgets/task_loop_panel.py` (tabbed interface with Product Description and Task List), `src/gui/widgets/status_panel.py`, `src/gui/main_window.py`, `src/core/file_manager.py` (read_description method).
