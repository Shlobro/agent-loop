...
- The menu bar includes workflow control icon buttons (Start/Play, Pause, Stop) positioned in the top-right corner for quick access. These mirror the functionality of the Workflow menu items and the optional control buttons row.
